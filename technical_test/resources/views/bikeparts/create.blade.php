        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('bikeparts.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="harga" id="harga" class="form-input w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="stok" class="block text-gray-700 font-bold mb-2">Stock:</label>
                            <input type="number" name="stok" id="stok" class="form-input w-full" required>
                        </div>
